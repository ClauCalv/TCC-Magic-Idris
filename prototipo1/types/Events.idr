...
data Event
  ...
  | DidDeclareAttackers PlayerRef (List Attack)
...
-- Eu preciso entender porque esse "forall ty.". Não manjo de declarar funções dessa maneira.
...
data SimpleOneShotEffect
  ...
  -- ReorderLibraryCards
  | DrawCard PlayerRef -- Drawing is special [120.5] --TYPO!! Regra certa é a [121.5]
  ...
  | RevealCards PlayerRef (List (ObjectRef TyCard))
  --deriving Show

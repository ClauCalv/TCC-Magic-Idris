...
-- EU SÓ QUERIA UM DERIVING AAAAAAAAAAAAAAAAAAA cansei de implementar essas interfaces. Quando precisar eu faço.

record ObjectTypes where
...
--Não entendi pra que usar isso ainda então não vou mexer
{- Haskell:
...
data CreatureSubtype
  ...
  --deriving (Eq, Ord, Show, Read, Enum, Bounded) --isso vai dar uma dor de cabeça....
...
-- https://github.com/MedeaMelana/Magic/blob/master/Magic/src/Magic/ObjectTypes.hs

-- Isso tudo usa os Semigroup e Monoid que não definimos
-- TODO
{-Haskell:
